      ...
      <Section className="items-center justify-center pt-32 pb-20 border-b border-brown/20 bg-beige min-h-screen">
        ...
        <div className="max-w-screen-2xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center z-10 relative">
          ...
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 mb-4 px-3 py-1 rounded-full bg-brown text-beige border border-brown hover:border-red-muted hover:text-red-muted transition-colors">
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              {featurePills.map((pill, idx) => (
                <motion.div
                  ...
                  className="px-4 py-2 rounded-full border border-brown bg-white text-brown font-body text-xs font-medium uppercase hover:bg-red-muted hover:text-white hover:-translate-y-1 hover:shadow-md transition-all cursor-pointer"
                >
                  {pill}
                </motion.div>
              ))}
